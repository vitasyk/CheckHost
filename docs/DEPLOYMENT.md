...
## 🏗 Крок 1: Підготовка сервера (Автоматично)

Ви можете автоматично встановити Docker, Docker Compose та налаштувати фаєрвол за допомогою нашого скрипта:
...
> [!IMPORTANT]
> Після завершення роботи скрипта потрібно перелогінитися в систему, щоб права Docker набули чинності.
