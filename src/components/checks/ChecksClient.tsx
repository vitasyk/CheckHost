                        ...
                        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full relative">
                            ...
                            <div className="mt-0">
                                ...
                                <TabsContent value="ping">
                                    <CheckForm type="ping" host={host} maxNodes={maxNodes} onMaxNodesChange={setMaxNodes} onHostChange={setHost} onResults={handlePingResults} onCheckStart={(checkNodes) => handleCheckStart('ping', checkNodes, setPingNodes, setPingResults)} onCheckComplete={() => handleCheckComplete('ping')} errorMessage={errorMessage} isLoading={activeChecks.has('ping')} nodes={nodes} isReverseMtr={isReverseMtr} onReverseMtrToggle={handleReverseMtrToggle} selectedNodeIds={selectedNodeIds} selectedNodeCount={selectedNodeIds.length} onToggleMap={() => setShowMap(!showMap)} onClearSelection={clearSelectedNodes} isMapVisible={showMap} autoStart={autoStart && activeTab === 'ping'} />
                                ...
                                <TabsContent value="http">
                                    <CheckForm type="http" host={host} maxNodes={maxNodes} onMaxNodesChange={setMaxNodes} onHostChange={setHost} onResults={handleHttpResults} onCheckStart={(checkNodes) => handleCheckStart('http', checkNodes, setHttpNodes, setHttpResults)} onCheckComplete={() => handleCheckComplete('http')} errorMessage={errorMessage} isLoading={activeChecks.has('http')} nodes={nodes} isReverseMtr={isReverseMtr} onReverseMtrToggle={handleReverseMtrToggle} selectedNodeIds={selectedNodeIds} selectedNodeCount={selectedNodeIds.length} onToggleMap={() => setShowMap(!showMap)} onClearSelection={clearSelectedNodes} isMapVisible={showMap} autoStart={autoStart && activeTab === 'http'} />
                                ...
                                <TabsContent value="tcp">
                                    <CheckForm type="tcp" host={host} maxNodes={maxNodes} onMaxNodesChange={setMaxNodes} onHostChange={setHost} onResults={handleTcpResults} onCheckStart={(checkNodes) => handleCheckStart('tcp', checkNodes, setTcpNodes, setTcpResults)} onCheckComplete={() => handleCheckComplete('tcp')} errorMessage={errorMessage} isLoading={activeChecks.has('tcp')} nodes={nodes} isReverseMtr={isReverseMtr} onReverseMtrToggle={handleReverseMtrToggle} selectedNodeIds={selectedNodeIds} selectedNodeCount={selectedNodeIds.length} onToggleMap={() => setShowMap(!showMap)} onClearSelection={clearSelectedNodes} isMapVisible={showMap} autoStart={autoStart && activeTab === 'tcp'} />
                                ...
                                <TabsContent value="udp">
                                    <CheckForm type="udp" host={host} maxNodes={maxNodes} onMaxNodesChange={setMaxNodes} onHostChange={setHost} onResults={handleUdpResults} onCheckStart={(checkNodes) => handleCheckStart('udp', checkNodes, setUdpNodes, setUdpResults)} onCheckComplete={() => handleCheckComplete('udp')} errorMessage={errorMessage} isLoading={activeChecks.has('udp')} nodes={nodes} isReverseMtr={isReverseMtr} onReverseMtrToggle={handleReverseMtrToggle} selectedNodeIds={selectedNodeIds} selectedNodeCount={selectedNodeIds.length} onToggleMap={() => setShowMap(!showMap)} onClearSelection={clearSelectedNodes} isMapVisible={showMap} autoStart={autoStart && activeTab === 'udp'} />
                                ...
                                <TabsContent value="dns">
                                    <CheckForm type="dns" host={host} maxNodes={maxNodes} onMaxNodesChange={setMaxNodes} onHostChange={setHost} onResults={handleDnsResults} onCheckStart={(checkNodes) => handleCheckStart('dns', checkNodes, setDnsNodes, setDnsResults)} onCheckComplete={() => handleCheckComplete('dns')} errorMessage={errorMessage} isLoading={activeChecks.has('dns')} nodes={nodes} isReverseMtr={isReverseMtr} onReverseMtrToggle={handleReverseMtrToggle} selectedNodeIds={selectedNodeIds} selectedNodeCount={selectedNodeIds.length} onToggleMap={() => setShowMap(!showMap)} onClearSelection={clearSelectedNodes} isMapVisible={showMap} dnsType={dnsType} onDnsTypeChange={setDnsType} autoStart={autoStart && activeTab === 'dns'} />
