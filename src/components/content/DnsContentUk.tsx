            ...
            <Card className="border-none shadow-none bg-transparent">
                ...
                <CardContent className="px-0 space-y-6">
                    <div>
                        ...
                        <p>
                            Систему доменних імен (DNS) часто називають &quot;телефонною книгою Інтернету&quot;. Вона перетворює зручні для читання доменні імена (наприклад, {process.env.NEXT_PUBLIC_SITE_NAME || 'checknode.io'}) на IP-адреси, які комп&apos;ютери використовують для ідентифікації один одного в мережі. Перевірка DNS запитує певні сервери імен (nameservers), щоб отримати поточні записи DNS, пов&apos;язані з доменом.
                        </p>
                    </div>
