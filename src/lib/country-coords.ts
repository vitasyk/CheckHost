/**
 * Central coordinates for countries (ISO 3166-1 alpha-2)
 * Provided as a fallback when exact city coordinates are unavailable.
 */
...
/**
 * Get central coordinates for a country code
 */
