...
export async function GET(
    ...
    const url = `https://check-host.net/check-result-extended/${requestId}`;
    ...
    try {
        ...
        return NextResponse.json({ error: 'Failed to fetch extended results' }, { status: 500 });
    }
}
